...
ggplot(ems_model, aes(y = Scenario, x = sim_time)) +
  ...
  scale_x_continuous(
    # CHANGE 1: Update the axis title to reflect minutes
    "Total Response Time (minutes)",
    # CHANGE 2: Set breaks in seconds (e.g., every 5 minutes = 300 seconds)
    # Using a range up to 2000 seconds (your maximum)
    breaks = seq(0, 2000, 150),
    # CHANGE 3: Convert the seconds (x) to minutes for the label display
