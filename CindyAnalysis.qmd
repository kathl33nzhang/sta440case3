...
ems <- x |>
  ...
  select(REF.GRID, DISPATCH.PRIORITY.NAME, REF.GPS.LAT, REF.GPS.LON, VEHCGPS, actual_travel_time) |>
...
ems_pts = st_as_sf(ems, coords = c("REF.GPS.LON","REF.GPS.LAT"), crs = 4326)
...
ems$sector_id <- ems_pts_with_sector$sector_id

# (optional) quick check
table(is.na(ems$sector_id))
head(ems$sector_id)
```
```{r}
# Assumes:
